...
import {metadatas, versions, deploymentIds, mmrRoot} from './constants';
import {IndexerRegistry, QueryRegistry, Staking, SQToken, PurchaseOfferMarket} from '../src';
...
describe('Query Registry Contract', () => {
    ...
    describe('Indexing Query Project', () => {
        ...
        it('stop indexing with invalid condition should fail', async () => {
            ...
            await createPurchaseOffer(purchaseOfferMarket, deploymentId);
